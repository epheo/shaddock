...
setup(
    ...
    entry_points={
        ...
        'panama.cli': [
            'simple = panama.simple:Simple',
            'two_part = panama.simple:Simple',
            'error = panama.simple:Error',
            'list containers = panama.list:Containers',
            'list = panama.list:Containers',
            'file = panama.show:File',
            'show file = panama.show:File',
        ],
    },
